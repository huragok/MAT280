...
\begin{document}
  ...
  \begin{homeworkProblem}
    ...
    matter which norm we use) is vastly different from $\|x - y\|$.
...
\end{lstlisting}
    ...
    Johnson-Lindenstrauss projection, Fast Johnson Lindenstrauss projection and
    simple random sampling (i.e., randomly picking $k$ indices).
