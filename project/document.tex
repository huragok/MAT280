...
knowledge/experience on statistics, programming is well-equipped to ``learn''
about a city in various aspects, a realm used to be dominated primarily by
...
used as an indicator on how active each CT is. With a simple unsupervised
learning technique, namely spectral clustering, as well as straightforward
visualization results, we successfully review the distinct ``day-time'' and
``night-time'' neighborhoods of NYC.
...
how we adopt the spectral-clustering method to clusters the CTs into two groups
according to the hourly pickup-dropoff patterns.
...
\section{Spatial-Temporal Distribution of the Trips}
\label{sec:explore}
% Outline
